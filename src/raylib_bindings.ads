...
package Raylib_Bindings is
   ...
   procedure Draw_Rectangle_V
     (position : Raylib_Types.Vector2;
      size     : Raylib_Types.Vector2;
      color    : Raylib_Types.Color);
   pragma Import (C, Draw_Rectangle_V, "DrawRectangleV");

   procedure Draw_Rectangle_Rec
     (rec : Raylib_Types.Rectangle; color : Raylib_Types.Color);
   ...
   procedure Draw_Triangle
     (v1, v2, v3 : Raylib_Types.Vector2; color : Raylib_Types.Color);
   pragma Import (C, Draw_Triangle, "DrawTriangle");

   function Load_Texture
     (file_name : Interfaces.C.char_array) return Raylib_Types.Texture;
   ...
   function Load_Sound
     (file_name : Interfaces.C.char_array) return Raylib_Types.Sound;
   ...
   procedure Set_Sound_Volume
     (sound : Raylib_Types.Sound; volume : Interfaces.C.C_float);
   ...
   procedure Draw_Circle_Gradient
     (center_x, center_y : Interfaces.C.int;
      radius             : Interfaces.C.C_float;
      color1, color2     : Raylib_Types.Color);
   ...
   procedure Draw_Texture_Pro
     (texture      : Raylib_Types.Texture;
      source, dest : Raylib_Types.Rectangle;
      origin       : Raylib_Types.Vector2;
   ...
   function Measure_Text_Ex
     (font               : Raylib_Types.Font;
      text               : Interfaces.C.char_array;
      font_size, spacing : Interfaces.C.C_float) return Raylib_Types.Vector2;
